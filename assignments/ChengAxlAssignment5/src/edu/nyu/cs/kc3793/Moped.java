...
public class Moped {
	...
	public void printLocationNOrientation(){
		...
		if (street!=11 && (stString.substring(stString.length()-1)).equals("1")) {
			stOrdinal = "st";
		}
		else if (street!=12 && (stString.substring(stString.length()-1)).equals("2")) {
			stOrdinal = "nd";
		}
		else if (street!=13 && (stString.substring(stString.length()-1)).equals("3")) {
			stOrdinal = "rd";
		}
