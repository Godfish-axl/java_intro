...
public class MopedsOnTheRoadResubmission {

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		MopedResubmission userMoped = new MopedResubmission();
		userMoped.setUsername("userMoped");
		...
		MopedResubmission Rick = new MopedResubmission((int)(Math.random()*200.0+1),ave1,(int)(Math.random()*4.0));
		MopedResubmission Morty = new MopedResubmission((int)(Math.random()*200.0+1),ave2,(int)(Math.random()*4.0));
